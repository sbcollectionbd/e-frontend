      ...
      <div className="container flex items-center justify-between h-16 px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="hidden md:flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 text-green-600 hover:bg-green-50 hover:text-green-700"
          >
            {/* WhatsApp SVG Icon */}
            <svg
      ...
      {mobileOpen && (
        <nav className="md:hidden border-t bg-background/95 backdrop-blur-xl p-4 flex flex-col gap-1">
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={() => setMobileOpen(false)}
            className="text-sm font-medium text-green-600 hover:text-green-700 hover:bg-green-50 px-4 py-3 rounded-xl transition-colors flex items-center gap-2"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
